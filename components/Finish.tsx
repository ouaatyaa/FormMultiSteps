  ...
  return (
    ...
    >
      <div className="flex flex-col flex-grow">
        <div className=" h-[112px] flex  justify-between items-center py-10  bg-Pastelblue/10  rounded-t-md px-8">
          <div className="mb-2">
        ...
        <div className="flex flex-col flex-grow">
          <div className=" bg-Pastelblue/10  h-[104px] rounded-b-md px-8">
            <div className=" my-4">
              {svc.map((el, i) => (
